...
routerInfrarrojo.get("/datosInfrarrojo/:idnodo", (req, res) => {
...
routerInfrarrojo.post("/datosInfrarrojo", (req, res) => {
  var json1 = req.body;
  console.log(json1);
  ...
  connection.getConnection(function (error, tempConn) {
    if (error) {
      ...
      const checkUserQuery = `SELECT COUNT(*) AS count FROM datosinfrarrojo WHERE idnodo = ?`;
...
routerInfrarrojo.delete("/datosInfrarrojo", (req, res) => {
...
routerInfrarrojo.put("/datosInfrarrojo", (req, res) => {
  var json1 = req.body;
  console.log(json1);
...
module.exports = routerInfrarrojo;
